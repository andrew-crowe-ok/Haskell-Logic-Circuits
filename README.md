...
Upon loading the program, functions from every file are available to call directly. Or, type "main" to enter the main menu. "main" is also required to start the (AI-written, untested) tests in Tests.hs.
